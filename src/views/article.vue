<template>
    <div v-loading="loading" class="global-wrap article-wrap">
        ...
        <div ref="navigation" class="navigation" flex="~ justify-center items-center" h-42px bg-hex-fff>
            <div flex="~ justify-between auto wrap" max-w-1294px>
                <div flex-auto text-hex-8a8a8a lt-s1366="mx-24px">当前位置：<router-link to="/">首页</router-link> » SQLite文章</div>
                <div cursor-pointer lt-s1366="mx-24px" @click="layer.show = true">发布文章</div>
            </div>
        </div>
                            ...
                            <ul>
                                ...
                                >
                                    ...
                                    <div flex-1>
                                        ...
                                        <p text="14px hex-8a8a8a" line-3 lh-21px>{{ item.content }}</p>
                                    </div>
                                </li>
                            </ul>
